define(["knockout", "section"], function(ko, Section) {
    ...
    return function() {
        ...
        this.sections = ko.observableArray([
            ...
            new Section("three", "sample"),
            new Section("four", "sample"),
            new Section("five", "sample"),
            new Section("six", "sample"),
            new Section("seven", "sample"),
            new Section("eight", "sample"),
            new Section("nine", "sample"),
            new Section("ten", "sample"),
            new Section("end")
        ]);
